...
To achieve stage IV cosmographic accuracy with time delay lenses, the
...
redshifts and stellar masses of all galaxies in the fields of each
cosmographic lens.  We can remove the majority of the bias due to
external convergence by forward modeling
\cite{WongEtal2011,McCullyEtal2016}. However, for some lens fields,
...
The $\sim 30$ most important galaxies need to be modeled in full, making
...
require photometric data \cite{McCullyEtal2016}. Such models give an
uncertainty of a few percent on the external convergence for an
individual lens. Spectroscopy can also provide the velocity
dispersion of both the lens galaxies and galaxies in the lens
environment or along the line of sight. The velocity dispersion of the
main lens galaxy allows us to break the lens radial profile degeneracy,
one of the key systematic uncertainties for measuring cosmology using
time delay cosmography; measuring this in the parent population (and not
just the subset selected for targeted high resolution follow-up) will
enlarge the sample of cosmologically-informative systems. The velocity
dispersion of the environment/line of sight galaxies will allow more
effective forward modeling, further reducing the residual bias in
external convergence estimates by a factor of two
\cite{CollettEtal2013}.

Characterization of weak lensing effects for strong lensing has similar
needs to that needed to model intrinsic alignments, and can find strong
synergy with photo-z calibration surveys. By selecting only the most
important galaxies for spectroscopy, each lens field should only need a
single pointing from a Multi-object spectrograph, e.g. DESI, though
fiber collisions may necessitate multiple pointings. The technical
requirements, and observing costs, of the strong lensing program are
